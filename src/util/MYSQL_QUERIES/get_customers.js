 ...
 * @param {string} cust_Id This contains the customer id inorder fetch the customer data by matching the id.
 * @returns This method returns a resolve object of promise if the query is executed sucessfully or returns a reject object of promise contains the error message.
 */
...
exports.updateCustomer = (customer, cust_id) => {
  ...
  // console.log(customer.custName, " is customer name");
  // console.log(customer.email, "is custimer email");
  return new Promise((resolve, reject) => {
    connection.query(
...
exports.updateAddress = (address) => {
  return new Promise((resolve, reject) => {
    connection.query(
      "UPDATE addresses SET house_number=?, street=?, city =?, state=?, country=?, postal_code =? WHERE address_Id",
      [
